...
# Copy STS file
src_path="${this_file_path}/src/pynxtools_spm/nomad/examples/sts/STSExampleWithCustomization"
sts_dst="./docs/assets/nomad_examples/sts"
mkdir -p $sts_dst
...
# Copy STM file
src_path="${this_file_path}/src/pynxtools_spm/nomad/examples/stm/STMExampleWithCustomization"
stm_dst="./docs/assets/nomad_examples/stm"
mkdir -p $stm_dst
...
# Copy AFM file
src_path="${this_file_path}/src/pynxtools_spm/nomad/examples/afm/AFMExampleWithCustomization"
afm_dst="./docs/assets/nomad_examples/afm"
mkdir -p $afm_dst
