...
def copy_config_and_plain_eln():
    ...
    src_config = (
        "tests/data/nanonis/sts/v_gen_5_descrb_nx_dt/config.json"
    )
    dst_eln = "docs/included_file_content/sts/eln_data.yaml"
    src_eln = "tests/data/nanonis/sts/v_gen_5_descrb_nx_dt/eln_data.yaml"
    ...
    src_config = (
        "tests/data/nanonis/stm/v_gen_5_descrb_nx_dt_down/config.json"
    )
    dst_eln = "docs/included_file_content/stm/eln_data.yaml"
    src_eln = "tests/data/nanonis/stm/v_gen_5_descrb_nx_dt_down/eln_data.yaml"
    dst_path = Path(dst_config)
    dst_path.parent.mkdir(parents=True, exist_ok=True)
    shutil.copy(src_config, dst_config)
    shutil.copy(src_eln, dst_eln)
    ...
    src_config = (
        "tests/data/nanonis/afm/v_gen_4_descrb_nx_dt_up/config.json"
    )
    dst_eln = "docs/included_file_content/afm/eln_data.yaml"
    src_eln = "tests/data/nanonis/afm/v_gen_4_descrb_nx_dt_up/eln_data.yaml"
    dst_path = Path(dst_config)
    dst_path.parent.mkdir(parents=True, exist_ok=True)
    shutil.copy(src_config, dst_config)
    shutil.copy(src_eln, dst_eln)
    ...
    src_config = "tests/data/bruker/afm/flt_descrb_nx_dt/config.json"
    dst_eln = "docs/included_file_content/bruker_afm/eln_data.yaml"
    src_eln = "tests/data/bruker/afm/flt_descrb_nx_dt/eln_data.yaml"
    dst_path = Path(dst_config)
    dst_path.parent.mkdir(parents=True, exist_ok=True)
    shutil.copy(src_config, dst_config)
    shutil.copy(src_eln, dst_eln)
    ...
    src_eln = "tests/data/bruker/afm/spm_v_9_4_dflt_conf_down/eln_data.yaml"
    dst_path = Path(dst_config)
    dst_path.parent.mkdir(parents=True, exist_ok=True)
    shutil.copy(src_config, dst_config)
    shutil.copy(src_eln, dst_eln)
...
def copy_miscellaneous_files():
    ...
    src = "tests/data/nanonis/sts/v_gen_5_descrb_nx_dt/Bias-Spectroscopy00015_20230420.dat"
    dst_path = Path(dst)
    dst_path.parent.mkdir(parents=True, exist_ok=True)
