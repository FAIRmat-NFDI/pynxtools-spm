...
=== "Parse a Bruker SPMLab file from AFM Experiment"
    <div class="scrollable">
    ```python
...
=== "Parse a Bruker NanoScope file from AFM Experiment"
    <div class="scrollable">
    ```python
...
=== "Parse a Bruker NanoScope force-curve file from AFM Experiment"
    <div class="scrollable">
    ```python
...
=== "Curate a Bruker SPMLab file from AFM experiment"
    <div class="scrollable">
    ```python
...
=== "Curate a Bruker NanoScope file from AFM experiment"
    <div class="scrollable">
    ```python
...
=== "Curate a Bruker NanoScope force-curve file from AFM experiment"
    <div class="scrollable">
    ```python
